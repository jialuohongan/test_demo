...
-- 示例景点（含红色历史）
INSERT INTO scenic_spot (scenic_name, location, description, red_history, check_count) VALUES
('遵义会议会址', '贵州省遵义市红花岗区', '中国共产党历史上生死攸关的转折点。', '1935年1月，中共中央在此召开政治局扩大会议，确立了毛泽东在党和红军中的领导地位。', 12),
('井冈山革命根据地', '江西省吉安市', '中国革命的摇篮。', '1927年10月，毛泽东在此创建了第一个农村革命根据地。', 8),
('延安革命纪念馆', '陕西省延安市', '展示中国共产党在延安时期革命斗争历史的综合性纪念馆。', '1935-1948年，中共中央在此指挥抗日战争和解放战争。', 6),
('西柏坡中共中央旧址', '河北省石家庄市平山县', '解放战争时期中共中央所在地。', '1948年5月至1949年3月，中共中央在此指挥三大战役。', 5);
